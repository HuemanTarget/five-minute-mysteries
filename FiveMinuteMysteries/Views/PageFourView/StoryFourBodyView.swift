        ...
        GroupBox {
          TabView {
            ...
            VStack(spacing: 30) {
              ...
              .fullScreenCover(isPresented: $isPresented, content: StoryViewFive.init)
              .background (
...
struct StoryFourBodyView_Previews: PreviewProvider {
  static var previews: some View {
    StoryFourBodyView(epOne: epOneChoices[0])
  }
}
